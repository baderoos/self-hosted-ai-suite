            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-3">
                  ...
                  >
                    <agent.icon
                      size={16}
                      className={`${
                        colorClassMap[agent.color]?.text ||
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <span
                    className={`text-xs font-medium px-2 py-0.5 rounded-full ${getAgentStatusColor(
                      agent.status
                    )}`}
                  >
                    {agent.status}
              ...
              <div className="mt-2 w-full bg-neutral-200 dark:bg-neutral-600 rounded-full h-1">
                <motion.div
                  className={`h-1 rounded-full ${
                    colorClassMap[agent.color]?.bar || "bg-neutral-500"
                  }`}
                  initial={{ width: 0 }}
