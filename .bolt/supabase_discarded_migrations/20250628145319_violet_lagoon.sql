/*
  # Fix profiles table and workspace RLS policies
  ...
  2. Security Policy Fixes
    ...
    - Simplify workspace creation policies to avoid circular dependencies

  3. Notes
    - The avatar_url column is added as nullable text field
    - RLS policies are restructured to prevent recursion during workspace creation
*/
...
CREATE POLICY "Users can view workspaces they are members of"
  ...
  USING (
    ...
    EXISTS (
      ...
      AND workspace_members.user_id = uid()
    )
  );
